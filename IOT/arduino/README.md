...
위의 예제코드를 사용하기 위해서는 일단 잘 설정된(드라이버가 설치된 컴퓨터와 보드 설정이 되어있는) Wemos D1 mini에 
...
단순히 핸드폰 배터리, 리모컨의 알카라인 건전지를 갈아끼우기만 하고 보통의 배터리 충전기와는 너무나도 다른 외견에 쉴드 배터리가 눈앞에 있어도 무엇을 하는 기기인지 몰라서 
