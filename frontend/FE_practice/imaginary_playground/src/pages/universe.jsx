          ...
          <>
            {planetCount !== 8 ? (
              <>
                ...
                {jupyter === true ? (
                  <>
                    <img
                      src="/assets/universe/jupyter.png"
            ...
            {planetCount === 8 ? (
              <>
                ...
                <img
                  src="/assets/universe/mercury.png"
                  className="mercury animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/venus.png"
                  className="venus animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/earth.png"
                  className="earth animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/mars.png"
                  className="mars animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/jupyter.png"
                  className="jupyter animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/saturn.png"
                  className="saturn animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/uranus.png"
                  className="uranus animate__animated animate__fadeOutUp"
                />
                <img
                  src="/assets/universe/neptune.png"
                  className="neptune animate__animated animate__fadeOutUp"
                />
                <img
